...
<?php echo do_shortcode('[contact-form-7 id="27" title="Need More Info"]') ?>
      ...
      <div
        ...
        <div class="tm_pb_text tm_pb_module tm_pb_bg_layout_light tm_pb_text_align_left  tm_pb_text_3">
          ...
          <h3><strong>New York Consumer Directed Personal Assistance Program</strong></h3>
          <p>Hire your own caregiver. Know and trust the person who will be responsible for your well-being. No more
            strangers, no more guessing, no more stress!</p>
          <hr>
        ...
        <div id="icon_custom1"
          ...
          <div class="tm_pb_blurb_content">
            <div class="tm_pb_main_blurb_image"></div>
            <div class="tm_pb_blurb_container">
              <h4>Someone You Trust &amp; Care About</h4>
              <div class="tm_pb_blurb_content">
              </div>
            </div>
        ...
        <div id="icon_custom2"
          ...
          <div class="tm_pb_blurb_content">
            <div class="tm_pb_main_blurb_image"></div>
            <div class="tm_pb_blurb_container">
              <h4>No More Stangers At Home</h4>
              <div class="tm_pb_blurb_content">
              </div>
            </div>
          </div> <!-- .tm_pb_blurb_content -->
        ...
        <div id="icon_custom3"
          ...
          <div class="tm_pb_blurb_content">
            <div class="tm_pb_main_blurb_image"></div>
            <div class="tm_pb_blurb_container">
              <h4>Manage Your Own Caregiver</h4>
              <div class="tm_pb_blurb_content">
              </div>
            </div>
          </div> <!-- .tm_pb_blurb_content -->
        ...
        <div id="icon_custom4"
          ...
          <div class="tm_pb_blurb_content">
            <div class="tm_pb_main_blurb_image"></div>
            <div class="tm_pb_blurb_container">
              <h4>Your Caregiver Gets Paid</h4>
              <div class="tm_pb_blurb_content">
              </div>
            </div>
          </div> <!-- .tm_pb_blurb_content -->
